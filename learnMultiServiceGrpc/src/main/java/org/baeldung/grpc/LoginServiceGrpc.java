...
public final class LoginServiceGrpc {
  ...
  public static final String SERVICE_NAME = "org.baeldung.grpc.LoginService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<org.baeldung.grpc.LoginRequest,
      org.baeldung.grpc.LoginResponse> getLoginMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "login",
      requestType = org.baeldung.grpc.LoginRequest.class,
      responseType = org.baeldung.grpc.LoginResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<org.baeldung.grpc.LoginRequest,
      org.baeldung.grpc.LoginResponse> getLoginMethod() {
    io.grpc.MethodDescriptor<org.baeldung.grpc.LoginRequest, org.baeldung.grpc.LoginResponse> getLoginMethod;
      ...
      synchronized (LoginServiceGrpc.class) {
        if ((getLoginMethod = LoginServiceGrpc.getLoginMethod) == null) {
          LoginServiceGrpc.getLoginMethod = getLoginMethod = 
              io.grpc.MethodDescriptor.<org.baeldung.grpc.LoginRequest, org.baeldung.grpc.LoginResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "org.baeldung.grpc.LoginService", "login"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.baeldung.grpc.LoginRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.baeldung.grpc.LoginResponse.getDefaultInstance()))
  ...
  public static abstract class LoginServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void login(org.baeldung.grpc.LoginRequest request,
        io.grpc.stub.StreamObserver<org.baeldung.grpc.LoginResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                org.baeldung.grpc.LoginRequest,
                org.baeldung.grpc.LoginResponse>(
                  this, METHODID_LOGIN)))
          .build();
    }
  }
  ...
  public static final class LoginServiceBlockingStub extends io.grpc.stub.AbstractStub<LoginServiceBlockingStub> {
    ...
    /**
     */
    public org.baeldung.grpc.LoginResponse login(org.baeldung.grpc.LoginRequest request) {
  ...
  public static final class LoginServiceFutureStub extends io.grpc.stub.AbstractStub<LoginServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<org.baeldung.grpc.LoginResponse> login(
        org.baeldung.grpc.LoginRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LOGIN:
          serviceImpl.login((org.baeldung.grpc.LoginRequest) request,
              (io.grpc.stub.StreamObserver<org.baeldung.grpc.LoginResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class LoginServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return org.baeldung.grpc.LoginServiceOuterClass.getDescriptor();
    }
